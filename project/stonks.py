...
from project.patterns.historical_pattern_analysis import main as analyze_main, scan_ticker
...
def wipe_imports():
    ...
    if os.path.exists(data_dir):
        ...
        print("[✔] Wiped all imported ticker data.")
    else:
        print("[!] Ticker data directory not found.")
...
def wipe_anal():
    ...
    if os.path.exists(path):
        os.remove(path)
        print("[✔] Wiped historical analysis results.")
    else:
        print("[!] No analysis file to wipe.")
